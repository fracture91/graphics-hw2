...
void display(void) {
	...
	Angel::mat4 perspective = Angel::Perspective(45.0, width/height, 0.1, 100.0);

	// mat4() is identity matrix by default
	Angel::mat4 model = Angel::mat4() * Angel::Translate(0.0, 0.0, -2.0f)
	                  * Angel::RotateY(45.0f) * Angel::RotateX(35.0f);
	...
	glUniformMatrix4fv(projLoc, 1, GL_TRUE, perspective);
